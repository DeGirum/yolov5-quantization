...
#     nl = 3 # number of detection layers (to scale hyps)
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if opt.image_weights:
            cw = model_fused_and_prepared.class_weights.cpu().numpy() * (1 - maps) ** 2 / nc  # class weights
...
#             print ("multiscale")
            ...
            if ni - last_opt_step >= accumulate:
                ...
                torch.nn.utils.clip_grad_norm_(model_fused_and_prepared.parameters(), max_norm=10.0)  # clip gradients
            ...
            if RANK in {-1, 0}:
                ...
                callbacks.run('on_train_batch_end', model_fused_and_prepared, ni, imgs, targets, paths, list(mloss))
